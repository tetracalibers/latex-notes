...
\begin{proof}
  ...
  \begin{subpattern}{\bfseries $\phi_1, \ldots, \phi_n$が$(\mathbb{R}^n)^*$を張ること}
    ...
    よって、$\mathbb{R}^n$の基底$\{\vb*{u}_1, \ldots, \vb*{u}_n\}$に対して同じ値をとることから、\thmref{thm:linear-map-equality-on-basis}より、
    \begin{equation*}
...
また、\thmref{thm:abstract-linear-pigeonhole}より、次元が等しいことから、$\mathbb{R}^n$と$(\mathbb{R}^n)^*$は線形同型である。
