...
\begin{proof}
  ...
  \thmref{thm:basis-extension}より、$\vb*{v}_1,\ldots,\vb*{v}_m,\vb*{v}_{m+1},\ldots,\vb*{v}_{n}$が$K^n$の基底となるように、$n-m$個のベクトル$\vb*{v}_{m+1},\ldots,\vb*{v}_{n}$を追加して基底を延長できる
  ...
  基底の線型独立性と\thmref{thm:invertible-iff-col-indep}より、$P$は正則であるので、
  \begin{equation*}
