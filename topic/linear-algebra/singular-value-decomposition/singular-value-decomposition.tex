...
\begin{proof}
  \begin{subpattern}{(\romannum{i}) $AA^\top \vb*{u} = \vb*{o}$\bfseries について}
  ...
  \begin{subpattern}{(\romannum{ii}) $A^\top A \vb*{v} = \vb*{o}$\bfseries について}
...
\end{equation*}
に写像するから、\thmref{thm:orthobasis-formula-for-rep-matrix}より、$A$は
\begin{equation*}
