...
\begin{proof}
  ...
  ここで、$\rho = \sigma^{-1}$とおくと、$\sigma = \rho^{-1}$であり、\thmref{thm:sign-of-inverse-permutation}から$\sgn(\sigma) = \sgn(\rho^{-1}) = \sgn(\rho)$であるから、
  \begin{equation*}
...
\begin{proof}
  ...
  このとき、\thmref{thm:sum-invariance-under-permutation-action}より、
  \begin{equation*}
  ...
  さらに、\thmref{thm:sign-multiplicativity}より、
  \begin{equation*}
...
\thmref{thm:determinant-transpose-invariance}より、次の定理も得られる
