...
\begin{proof}
  ...
  一方、\thmref{thm:orthogonal-set-is-independent}より、$\vb*{e}_1, \ldots, \vb*{e}_n$も直交系であることから線型独立であるため、$\langle \vb*{e}_1, \ldots, \vb*{e}_n \rangle$の次元も$n$である。

  よって、\thmref{thm:equal-dim-implies-equal-subspace}より、部分空間の次元が等しいことから、両者は一致する。 $\qed$
\end{proof}
...
ここで、$\vb*{a}_1, \ldots, \vb*{a}_{k-1}$から得られた正規直交系を$\vb*{e}_1, \ldots, \vb*{e}_{k-1}$とすると、\thmref{thm:gram-schmidt-span-invariance}より、これらの張る空間は一致する。
\begin{equation*}
