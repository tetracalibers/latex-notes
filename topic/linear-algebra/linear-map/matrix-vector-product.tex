...
\secref{sec:matrix-linear-map-notation}では、線形写像$f$による像$f(\vb*{v})$を、行列$A$を用いて次のように表した。
\begin{equation*}
...
\secref{sec:matrix-linear-map-notation}で線形写像$f$から行列$A$を作ったのとは逆に、任意の行列から線形写像を作ることもできる。
