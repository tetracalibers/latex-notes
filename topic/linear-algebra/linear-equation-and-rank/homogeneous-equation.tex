...
\secref{sec:general-solution-parametric-form}で具体例として挙げた連立一次方程式
\begin{equation*}
...
\secref{sec:fundamental-and-particular-solutions}でも述べたように、特殊解を$\vb*{x}_0$、基本解を$\vb*{u}_i$とすると、$A\vb*{x} = \vb*{b}$の一般解は次のように表せる。
\begin{equation*}
