...
\begin{figure}[h]
  ...
  \begin{minipage}{0.49\columnwidth}
    ...
    \begin{tikzpicture}
      ...
      \node [draw, lightslategray, rounded corners, fit={(first) (last)}, minimum width=2em, inner sep=0.2em, xshift=-6em] (cityA) {A\bfseries 市};
      \node [draw, lightslategray, rounded corners, fit={(first) (last)}, minimum width=2em, inner sep=0.2em, xshift=6em] (cityB) {B\bfseries 市};
    \end{tikzpicture}
  \end{minipage}
\end{figure}
...
\begin{theorem}{和の法則}\label{thm:rule-of-sum}
  AとBは同時に起こらないとする。
...
\begin{center}
  \begin{tikzpicture}
    ...
    \node [draw, lightslategray, rounded corners, fit={(first) (last)}, minimum width=2em, inner sep=0.2em, xshift=18em] (cityB) {B\bfseries 市};
  \end{tikzpicture}
\end{center}
