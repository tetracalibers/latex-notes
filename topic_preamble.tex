...
\renewcommand{\qedsymbol}{\textcolor{black!75}{$\blacksquare$}}
...
\DeclareTColorBox{proof}{}{%
  empty,
  title={\textcolor{ProofColor}{\faParagraph}証明},
  ...
  vfill before first,
  overlay unbroken={
      \draw[ProofColor,line width=1pt]
...
\newcommand{\sectionline}{\vspace{-0.5\baselineskip}\froufrou\vspace{-0.5\baselineskip}}
